...
export default function About() {
  return (
    <section
      ...
      className="portfolio-section relative scroll-mt-20 overflow-x-clip bg-transparent px-5 pb-24 pt-16 sm:px-8 sm:pb-28 sm:pt-20 lg:px-12 lg:pb-32 lg:pt-20"
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl gap-14 lg:grid-cols-[minmax(260px,0.72fr)_minmax(0,1.28fr)] lg:gap-20">
        ...
        <div>
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2">
            <article className="group relative overflow-hidden rounded-3xl border border-gray-200 bg-gray-50 p-7 transition-colors hover:border-[#FB6C00]/35 sm:col-span-2 sm:p-8">
            ...
            <article className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm shadow-gray-900/5 transition hover:-translate-y-1 hover:border-[#FB6C00]/35 hover:shadow-lg hover:shadow-[#FB6C00]/8">
